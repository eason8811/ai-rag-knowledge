...
function appendMessage(content, isAssistant = false, saveToStorage = true) {
 ...
 function startEventStream(message) {
    ...
    // 选项值，
    // 组装01；http://localhost:8080/api/v1/ollama/generate_stream?message=Hello&model=deepseek-r1:1.5b
    // 组装02；http://localhost:8080/api/v1/openai/generate_stream?message=Hello&model=gpt-4o
